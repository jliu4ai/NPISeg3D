...
class EvaluatorMO():
    ...
    def eval_results(self):
        ...
        results_dict = {
            ...
            'IoU@2': IOU_PER_CLICK_dict['2.0']/NOO_PER_CLICK_dict['2.0'],
            'IoU@3': IOU_PER_CLICK_dict['3.0']/NOO_PER_CLICK_dict['3.0'],
            'IoU@4': IOU_PER_CLICK_dict['4.0']/NOO_PER_CLICK_dict['4.0'],
            'IoU@5': IOU_PER_CLICK_dict['5.0']/NOO_PER_CLICK_dict['5.0'],
            'IoU@6': IOU_PER_CLICK_dict['6.0']/NOO_PER_CLICK_dict['6.0'],
            'IoU@7': IOU_PER_CLICK_dict['7.0']/NOO_PER_CLICK_dict['7.0'],
            'IoU@8': IOU_PER_CLICK_dict['8.0']/NOO_PER_CLICK_dict['8.0'],
            'IoU@9': IOU_PER_CLICK_dict['9.0']/NOO_PER_CLICK_dict['9.0'],
            'IoU@10': IOU_PER_CLICK_dict['10.0']/NOO_PER_CLICK_dict['10.0'],
            'IoU@11': IOU_PER_CLICK_dict['11.0']/NOO_PER_CLICK_dict['11.0'],
            'IoU@12': IOU_PER_CLICK_dict['12.0']/NOO_PER_CLICK_dict['12.0'],
            'IoU@13': IOU_PER_CLICK_dict['13.0']/NOO_PER_CLICK_dict['13.0'],
            'IoU@14': IOU_PER_CLICK_dict['14.0']/NOO_PER_CLICK_dict['14.0'],
            'IoU@15': IOU_PER_CLICK_dict['15.0']/NOO_PER_CLICK_dict['15.0'],
            'IoU@16': IOU_PER_CLICK_dict['16.0']/NOO_PER_CLICK_dict['16.0'],
            'IoU@17': IOU_PER_CLICK_dict['17.0']/NOO_PER_CLICK_dict['17.0'],
            'IoU@18': IOU_PER_CLICK_dict['18.0']/NOO_PER_CLICK_dict['18.0'],
            'IoU@19': IOU_PER_CLICK_dict['19.0']/NOO_PER_CLICK_dict['19.0'],
            'IoU@20': IOU_PER_CLICK_dict['20.0']/NOO_PER_CLICK_dict['20.0']
        }
        print('****************************')
        print(results_dict)
