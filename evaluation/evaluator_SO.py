...
class EvaluatorSO():
    ...
    def __init__(
        ...
        self.label_all = labels[dataset] if dataset in ['scannet40', 's3dis', 'kitti360'] else None
    ...
    def eval_results(self):
        ...
        for iou_max in self.MAX_IOU:
            ...
            if self.label_all is not None:
                ...
                _, noc_all, noo_all, iou_per_click, noo_per_click = self.eval_per_class(
                    label=None,  # 不指定具体类别
                    MAX_IOU=iou_max, 
                    dataset_=self.dataset_list, 
                    dataset_classes=self.dataset_classes, 
                    exclude_classes=None
                )
                NOC[iou_max].append(noc_all)
                NOO[iou_max].append(noo_all)
        ...
        results_dict = {
            ...
            'IoU@4': IOU_PER_CLICK_dict['4']/NOO_PER_CLICK_dict['4'],
            'IoU@5': IOU_PER_CLICK_dict['5']/NOO_PER_CLICK_dict['5'],
            'IoU@6': IOU_PER_CLICK_dict['6']/NOO_PER_CLICK_dict['6'],
            'IoU@7': IOU_PER_CLICK_dict['7']/NOO_PER_CLICK_dict['7'],
            'IoU@8': IOU_PER_CLICK_dict['8']/NOO_PER_CLICK_dict['8'],
            'IoU@9': IOU_PER_CLICK_dict['9']/NOO_PER_CLICK_dict['9'],
            'IoU@10': IOU_PER_CLICK_dict['10']/NOO_PER_CLICK_dict['10'],
            'IoU@11': IOU_PER_CLICK_dict['11']/NOO_PER_CLICK_dict['11'],
            'IoU@12': IOU_PER_CLICK_dict['12']/NOO_PER_CLICK_dict['12'],
            'IoU@13': IOU_PER_CLICK_dict['13']/NOO_PER_CLICK_dict['13'],
            'IoU@14': IOU_PER_CLICK_dict['14']/NOO_PER_CLICK_dict['14'],
            'IoU@15': IOU_PER_CLICK_dict['15']/NOO_PER_CLICK_dict['15'],
            'IoU@16': IOU_PER_CLICK_dict['16']/NOO_PER_CLICK_dict['16'],
            'IoU@17': IOU_PER_CLICK_dict['17']/NOO_PER_CLICK_dict['17'],
            'IoU@18': IOU_PER_CLICK_dict['18']/NOO_PER_CLICK_dict['18'],
            'IoU@19': IOU_PER_CLICK_dict['19']/NOO_PER_CLICK_dict['19'],
